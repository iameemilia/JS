...
console.log('Добро '+'пожаловать, '+ 'Эмилия');
//Задание 5
...
const messengerMinutes = 128;
const likesMinutes = 254;
const readingMinutes = 137;
const youtubeMinutes = 201;
const totalMinutes = messengerMinutes + likesMinutes + readingMinutes + youtubeMinutes;
const totalHours = Math.floor(totalMinutes / 60)
console.log(`Русалка прокрастинировала ${totalHours} часов`);
...
const cleanerSalary = 40000;
const teacherSalary = 22000;
const totalSalary = cleanerSalary + teacherSalary;
console.log(`Вечерний уборщик, имею педагогическое образование, может заработать ${totalSalary}`);
